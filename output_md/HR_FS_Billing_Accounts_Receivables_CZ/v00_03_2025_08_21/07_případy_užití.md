...
Je známa částka k úhradě, případně oceněná událost a typ operace (top-up, placení offence, prodej OBU, prodej produktu, obejdnání OBU, objednání produktu\...).
...
- Time period 🡪 MIN(Bill.issue date) a MAX(Bill.issue date)
